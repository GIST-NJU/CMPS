...
def CMPS(ori_mdata,mr_mdata,budget):
    ...
    while budget > 0:
        ...
        for img_index in range(len(image_uncertainty_sorted)):
            ...
            index = img_index
            if img_path not in processed_img:  # and clus_count <= d and image_cluster[img_path] not in clus_list
    ...
    output_path = '/Users/miya_wang/Desktop/Papers/Second_paper/DNN-MT/replication/CMPS-NC/' + dataset + '_' + model + '_' + str(file_budget) + '.pkl'
